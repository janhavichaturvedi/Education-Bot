...
height: 95vh; background-image: url('images/bgimg.png');
}
form 
{
...
{
color: #eee; 
font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 50px;font-weight: 600;
position: fixed;
top: 0px;
z-index: 1;
left: 0px;
...
.input 
{
background-color: #303245; border-radius: 12px; border: 0;
box-sizing: border-box; color: #eee;
font-size: 18px;
height: 100%;
outline: 0;
padding: 4px 20px 0; width: 100%;
}
.cut 
{
background-color: #15172b; border-radius: 10px;
 height: 20px;
left: 20px;
position: absolute;
top: -20px;
...
<div class="input-container ic2">
<input type="password"id="password" name="password" class="input" type="text" placeholder=" "/>
<div class="cut"></div>
...
<h3>Don't have an account? <a href="http://localhost/education/register.php" style="color:white;" >Register</a></h3> 
</form>
